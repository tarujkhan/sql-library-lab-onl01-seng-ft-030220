...
def select_series_title_with_most_human_characters
   "SELECT series.title FROM characters JOIN series ON characters.species = species WHERE characters.species = 'human' group by species order by count(*) DESC limit 1"
end
